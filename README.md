...
Размер распакованного файла около 300 Мб. Количество строк - 590708 строк. <br>
В эту же папку после запуска пайплайна будут создаваться графики как результаты выполнения 5, 6 и 7 пунктов.
