...
RUN wget https://repo1.maven.org/maven2/com/clickhouse/clickhouse-jdbc/0.3.2-patch8/clickhouse-jdbc-0.3.2-patch8-all.jar && \
    mv clickhouse-jdbc-0.3.2-patch8-all.jar /opt/spark/spark-3.4.2-bin-hadoop3/jars
